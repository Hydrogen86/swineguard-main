    ...
    appointmentHTML += `
      <div class="appointment">
        ...
        <div class="appointment__more-details">
          ...
          <div class="appointment__more-details-columns">
            <div class="column left">
              <p class="column__detail">
                <span class="column__detail-label">Swine Title:</span>
              ...
              <p class="column__detail">
                ...
                <span class="column__detail-value">1${appointment.swineSymptoms}</span>
              </p>
              <p class="column__detail">
          ...
          <button class="appointment__more-details__accept-btn btn">Accept</button>
          <button class="appointment__more-details__confirm-btn btn" disabled>Confirm</button>
        </div>
      </div>
    `;
  });
...
// const acceptBtn = document.querySelector('.appointment__more-details__accept-btn');
// const confirmBtn = document.querySelector('.appointment__more-details__confirm-btn');
