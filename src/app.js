...
function renderAppointments(appointmentsToRender) {
  ...
  appointmentsToRender.forEach(appointment => {
    ...
    // disable and enable of buttons depends on status
    ...
    const actionDropdown = row.querySelector('.appointment-option');
    if (appointment.appointmentStatus === 'completed') { actionDropdown.disabled = true; }
